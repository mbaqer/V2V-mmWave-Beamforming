...
pwr_data_lst = df['unit1_pwr1'].values
original_beam = df['unit1_pwr1_best-beam'].values
...
def create_pos_beam_dataset():  
    ...
    lat = []
    lon = []
    pos_data_path = df['unit2_gps1'].values
    ...
    df_new['unit2_gps1_nor'] = pos_data   
    df_new['original_unit1_pwr1_best-beam'] = original_beam

    # Add additional columns with original data from the input file
    df_new['original_unit1_pwr1'] = df['unit1_pwr1']
